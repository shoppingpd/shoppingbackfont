...
INSERT INTO `使用者` VALUES (1,'user1','123456','user1@example.com','2025-10-04 14:57:57'),(2,'user2','123456','user2@example.com','2025-10-04 14:57:57'),(3,'user3','123456','user3@example.com','2025-10-04 14:57:57'),(4,'user4','123456','user4@example.com','2025-10-04 14:57:57');
...
CREATE TABLE `商品` (
  ...
  PRIMARY KEY (`商品編號`),
  KEY `上架者編號` (`上架者編號`),
  CONSTRAINT `商品_ibfk_1` FOREIGN KEY (`上架者編號`) REFERENCES `使用者` (`使用者編號`)
...
-- Dump completed on 2025-10-04 20:58:12
